...
new_off = pygame.image.load(resource_path("tanks", "images", "new_off.png")).convert_alpha()
new_off = pygame.transform.scale(new_off, (150, 30))
new_on = pygame.image.load(resource_path("tanks", "images", "new_on.png")).convert_alpha()
new_on = pygame.transform.scale(new_on, (150, 30))
join_off = pygame.image.load(resource_path("tanks", "images", "join_off.png")).convert_alpha()
join_off = pygame.transform.scale(join_off, (150, 30))
join_on = pygame.image.load(resource_path("tanks", "images", "join_on.png")).convert_alpha()
join_on = pygame.transform.scale(join_on, (150, 30))

icon = pygame.image.load(resource_path("tanks", "images", "icon.png")).convert_alpha()
